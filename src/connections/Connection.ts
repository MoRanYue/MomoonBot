...
export abstract class Connection {
  ...
  public abstract send(action: ConnectionEnum.Action, data?: Record<string, any> | string | null, cb?: DataType.ResponseFunction<any> | DataType.RawResponseFunction<any>): void
